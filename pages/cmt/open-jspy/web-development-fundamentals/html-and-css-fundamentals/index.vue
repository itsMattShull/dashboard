<template>
  <div>
    ...
    <section>
      <b-list-group>
        <b-list-group-item v-for="unit in courses[0].modules[2].units" :key="unit.index"><a :href="`/cmt/open-jspy/web-development-fundamentals/html-and-css-fundamentals/${unit.slug}`">{{unit.name}}</a></b-list-group-item>
      </b-list-group>
    </section>
  </div>
</template>
